...
p6 = win.addPlot(title='Elbow Signal')
...
p7 = win.addPlot(title='Shoulder Signal')
...
def callback(msg):
    ...
    global curve7, data7, ptr7, p7, curve72, data72
    global curve, data, ptr, p6, curve2, data2
    data.append(msg.data[0])
    data = data[-1000:]
    data2.append(msg.data[1])
    data2 = data2[-1000:]
    data7.append(msg.data[2])
    data7 = data7[-1000:]
    data72.append(msg.data[3])
    data72 = data72[-1000:]
    curve.setData(data)
    curve2.setData(data2)
    curve7.setData(data7)
    curve72.setData(data72)
